...
#define CONFIGURE_ARGS " '--prefix=/home/dbs/fdpvector/pgsql' '--enable-depend' '--enable-nls=utf-8' '--with-python'"
...
#define PG_VERSION_STR "PostgreSQL 16.13 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0, 64-bit"
